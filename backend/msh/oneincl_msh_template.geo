...
//Center of guide is at origin (0,0)

// Box points
Point(1) = {0-d/2,      hy/2,  0, lc};  // NW
Point(2) = {-hx-d/2,   -hy/2, 0, lc};   // SW
Point(3) = {-hx+d/2, -hy/2, 0, lc};     // SE
Point(4) = {d/2,      hy/2,  0,lc};     // NE
Point(10) = {-hx, hy/2, 0, lc};         // N
Point(11) = {-d/2,0, 0, lc};            // W
Point(12) = {-hx, -hy/2, 0, lc};        // E
Point(13) = {d/2, 0, 0, lc};            // S

// WG points 
Point(5) = {-hx, 0, 0, lc_refine_2};         // Centre
Point(6) = {-hx, radius1y, 0, lc_refine_1};  // WG N
Point(7) = {-hx-radius1, 0, 0, lc_refine_1}; // WG W
Point(8) = {-hx, -radius1y, 0, lc_refine_1}; // WG S
Point(9) = {-hx+radius1, 0, 0, lc_refine_1}; // WG E
...
If(rect == 1)
    Point(150) = {-hx+radius1, +radius1y, 0,lc_refine_1};
    Point(151) = {-hx-radius1, +radius1y, 0,lc_refine_1};
    Point(152) = {-hx+radius1, -radius1y, 0,lc_refine_1};
    Point(153) = {-hx-radius1, -radius1y, 0,lc_refine_1};
