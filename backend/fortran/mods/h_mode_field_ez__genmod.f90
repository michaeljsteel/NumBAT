        ...
        MODULE H_MODE_FIELD_EZ__genmod
          INTERFACE 
            SUBROUTINE H_MODE_FIELD_EZ(K_0,NVAL,NEL,NPT,NNODES_P2,      &
     &TABLE_NOD,X,BETAS,SOLN_K1,SOLN_H1)
              ...
              COMPLEX(KIND=8) :: SOLN_H1(3,NNODES_P2,NVAL,NEL)
            END SUBROUTINE H_MODE_FIELD_EZ
          END INTERFACE 
        END MODULE H_MODE_FIELD_EZ__genmod
