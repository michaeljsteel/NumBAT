        ...
        MODULE CSR_LENGTH__genmod
          INTERFACE 
            SUBROUTINE CSR_LENGTH(NEL,N_DDL,NEQ,NNODES,TABLE_N_E_F,INEQ,&
     &COL_IND,ROW_PTR,NONZ_MAX,NONZ,MAX_ROW_LEN,IPOINTER,INT_MAX,DEBUG)
              INTEGER(KIND=8) :: NEQ
            ...
            END SUBROUTINE CSR_LENGTH
          END INTERFACE 
        END MODULE CSR_LENGTH__genmod
