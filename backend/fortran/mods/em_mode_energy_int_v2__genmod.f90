        !COMPILER-GENERATED INTERFACE MODULE: Wed Jun 12 18:47:56 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE EM_MODE_ENERGY_INT_V2__genmod
          INTERFACE 
            SUBROUTINE EM_MODE_ENERGY_INT_V2(K_0,NVAL,NEL,NPT,NNODES_P2,&
     &TABLE_NOD,X,BETAS,SOLN_K1,OVERLAP)
          ...
          END INTERFACE 
        END MODULE EM_MODE_ENERGY_INT_V2__genmod
