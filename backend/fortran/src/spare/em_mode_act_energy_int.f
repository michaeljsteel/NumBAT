...
Cf2py intent(in) P2_NODES_PER_EL, elnd_to_mesh, type_el, nb_typ_el
Cf2py intent(in) x, soln_EM, n_lst
C
Cf2py depend(elnd_to_mesh) P2_NODES_PER_EL, nel
Cf2py depend(x) npt
Cf2py depend(soln_EM) P2_NODES_PER_EL, nval, nel
