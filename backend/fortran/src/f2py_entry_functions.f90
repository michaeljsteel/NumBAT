...
subroutine ac_alpha_analytic (n_modes, n_msh_elts, n_msh_pts, &
   ...
   integer(8), intent(in) :: n_msh_elts, n_msh_pts, n_elt_mats
   integer(8), intent(in) :: v_elt_material(n_msh_elts)
   integer(8), intent(in) :: m_elnd_to_mshpt(P2_NODES_PER_EL,n_msh_elts)
   double precision, intent(in) :: v_mshpt_xy(2,n_msh_pts)

   complex(8), intent(in) :: soln_ac_u(3,P2_NODES_PER_EL,n_modes,n_msh_elts)
   complex(8), intent(in) :: Omega_AC(n_modes)
   complex(8), intent(in) :: q_AC, v_ac_mode_energy(n_modes)
   complex(8), intent(in) :: eta_ijkl(3,3,3,3,n_elt_mats)
   ...
   call initialise_pyerror(nberr) ! use these to keep of2py quiet. It doesn't like method calls
...
subroutine ac_mode_power_analytic (n_modes, n_msh_elts, n_msh_pts,  &
   ...
   integer(8), intent(in) :: n_modes, n_msh_elts, n_msh_pts
   double precision, intent(in) :: v_mshpt_xy(2,n_msh_pts)
   integer(8), intent(in) :: m_elnd_to_mshpt(P2_NODES_PER_EL,n_msh_elts)
   integer(8), intent(in) :: n_elt_mats
   integer(8), intent(in) :: v_elt_material(n_msh_elts)
   complex(8), intent(in) :: stiffC_IJ_el(6,6,n_elt_mats)
...
subroutine ac_mode_power_quadrature (n_modes, n_msh_elts, n_msh_pts, &
   ...
   double precision, intent(in) :: v_mshpt_xy(2,n_msh_pts)
   integer(8), intent(in) :: m_elnd_to_mshpt(P2_NODES_PER_EL,n_msh_elts)
   integer(8), intent(in) :: n_elt_mats, v_elt_material(n_msh_elts)

   complex(8), intent(in) :: stiffC_zjkl(3,3,3,n_elt_mats)
   complex(8), intent(in) :: q_AC
   complex(8), intent(in) :: Omega_AC(n_modes)
   complex(8), intent(in) :: soln_ac_u(3,P2_NODES_PER_EL,n_modes,n_msh_elts)
...
subroutine EM_mode_energy_int (k_0, n_modes, n_msh_elts, n_msh_pts,&
   ...
   integer(8), intent(in) :: m_elnd_to_mshpt(P2_NODES_PER_EL,n_msh_elts)
   double precision, intent(in) :: v_mshpt_xy(2,n_msh_pts)
   complex(8), intent(in) :: soln_em_e(3,N_DOF_PER_EL,n_modes,n_msh_elts)
   complex(8), intent(in) :: v_beta(n_modes)
...
subroutine em_mode_act_energy_quadrature (n_modes, n_msh_elts, n_msh_pts, &
   ...
   integer(8), intent(in) :: n_elt_mats
   integer(8), intent(in) :: v_elt_material(n_msh_elts)
   complex(8), intent(in) :: v_refindex(n_elt_mats)
   complex(8), intent(in) :: soln_em_e(3,N_DOF_PER_EL,n_modes,n_msh_elts)
...
subroutine em_mode_power_sz_analytic (k_0, n_modes, n_msh_elts, n_msh_pts, &
   ...
   double precision, intent(in) :: k_0      !  k_0 = 2 pi / lambda, where lambda in meters.
   ...
   complex(8), dimension(n_modes), intent(out) :: m_power
   integer(8), intent(out) :: errco
   character(len=EMSG_LENGTH), intent(out) ::  emsg
...
subroutine h_mode_field_ez (k_0, n_modes, n_msh_elts, n_msh_pts, m_elnd_to_mshpt, &
 v_mshpt_xy, v_beta, soln_k1, soln_H1)
   ...
   integer(8), intent(in) :: m_elnd_to_mshpt(P2_NODES_PER_EL,n_msh_elts)
   double precision, intent(in) :: v_mshpt_xy(2,n_msh_pts)
   complex(8), intent(in) :: soln_k1(3,P2_NODES_PER_EL+7,n_modes,n_msh_elts)
   complex(8), intent(in) :: v_beta(n_modes)

   complex(8), intent(out) :: soln_H1(3,P2_NODES_PER_EL,n_modes,n_msh_elts)
...
subroutine moving_boundary (nval_em_p, nval_em_s, nval_ac, ival_p, ival_s, ival_ac, &
   ...
   use numbatmod
   integer(8), intent(in) :: nval_em_p, nval_em_s, nval_ac, ival_p, ival_s, ival_ac
   integer(8), intent(in) :: n_msh_elts, n_msh_pts, n_elt_mats
   ...
   integer(8), intent(in) :: typ_select_in, typ_select_out

   complex(8), intent(in) :: soln_em_p(3, P2_NODES_PER_EL, nval_em_p, n_msh_elts)
   complex(8), intent(in) :: soln_em_s(3, P2_NODES_PER_EL, nval_em_s, n_msh_elts)
   complex(8), intent(in) :: soln_ac_u(3, P2_NODES_PER_EL, nval_ac, n_msh_elts)
   complex(8), intent(in) :: v_eps_rel(n_elt_mats)
...
subroutine photoelastic_int_common (is_curvilinear, nval_em_p, nval_em_s, nval_ac_u, ival_p, &
   ...
   integer(8), intent(in) :: is_curvilinear
   integer(8), intent(in) :: nval_em_p, nval_em_s, nval_ac_u, ival_p, ival_s, ival_ac
   integer(8), intent(in) :: n_msh_elts, n_msh_pts, n_elt_mats
   integer(8), intent(in) :: v_elt_material(n_msh_elts)
   integer(8), intent(in) :: m_elnd_to_mshpt(P2_NODES_PER_EL,n_msh_elts)
   double precision, intent(in) :: v_mshpt_xy(2,n_msh_pts)
   complex(8), intent(in) :: soln_em_p(3,P2_NODES_PER_EL,nval_em_p,n_msh_elts)
   complex(8), intent(in) :: soln_em_s(3,P2_NODES_PER_EL,nval_em_s,n_msh_elts)
   complex(8), intent(in) :: soln_ac_u(3,P2_NODES_PER_EL,nval_ac_u,n_msh_elts)
   complex(8), intent(in) :: p_tensor(3,3,3,3,n_elt_mats)
   complex(8), intent(in) :: beta_ac
   complex(8), intent(in) :: v_eps_rel(n_elt_mats)
