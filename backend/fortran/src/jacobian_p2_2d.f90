!
!
!      x=[x0,y0] = coordinatate in the reference tetrahedron
!      x_g = Corresponding coordinatate in the actual tetrahedron
!
!    Matrix B: Compute the Affine mappings from the current Tetrahedron to the
