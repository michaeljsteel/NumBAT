...
class VoigtTensor3_iJ(object):
    ...
    def __init__(self, param_nm, physical_name='', physical_symbol='',
                 unit=None, transforms_like_piezo_d = False):
        """
        ...
        Args:
            ...
            physical_symbol (str): Symbol for display.
            unit (tuple or None): Unit information (name, scale).
            transforms_like_piezo_d (bool): Whether to apply factor 2 in Voigt conversion.
        """
        ...
        self._physical_symbol=physical_symbol
        self.unit=unit
        self._transforms_like_piezo_d = transforms_like_piezo_d  # converts to _ijk form with stiffness facs
    ...
    def _old_rotate(self, mat_R):
        ...
        T_ijk = Voigt3_iJ_to_ijk(self.mat, self._transforms_like_piezo_d)
        Tp_ijk = _rotate_3tensor(T_ijk, mat_R)
        self.mat = Voigt3_ijk_to_iJ(Tp_ijk, self._transforms_like_piezo_d)
