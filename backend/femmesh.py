...
class FemMesh:
    ...
    def store_fortran_em_mesh_properties(self, type_el, node_physindex, elnd_to_mshpt, v_mshpt_xy):
    ...
    def store_fortran_ac_mesh_properties(self, type_el, elnd_to_mshpt, v_mshpt_xy):
